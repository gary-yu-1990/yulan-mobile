<template>
  <div class="bank">
    ...
    <div class="all-bank">
      <div class="single-bank"v-for="(singleBank,index) in allLists">
  ...
  export default {
    ...
    methods: {
      ...
      getList () {
        ...
        let url = this.capitalUrl + '/returnCompensationBill/getReturnCompensationBills.do'
        console.log(url)
        axios.get(url,{
          params: {
          ...
          res => {
            ...
            if (this.allLists.length == 0) {
              ...
              for (let i = 0; i < this.allLists.length; i++) {
                ...
                this.allLists[i].reassureTs = this.exchangeTime(this.allLists[i].reassureTs)
