<template>
  <div class="bank-details">
    ...
    <div class="bank-details-msg">
      ...
      <div class="msg">
        <div><span class="left">总金额（小写）</span><span class="right">{{totleAcount}}元</span></div>
        <div><span class="left">总金额（大写）</span><span class="right">{{digitUppercase(totleAcount)}}</span></div>
      </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      initDetails () {
        let url = this.capitalUrl + '/returnCompensationBill/getReturnCompensationBillByID.do\t'
        axios.get(url,{
          params: {
