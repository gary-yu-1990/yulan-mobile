      ...
      <ul class="lists">
        ...
        <li class="order-num">订购数量：
          <div class="input-num-right" v-if="dwType">
            <input class="input-num" v-model.number="sum" @input="oninput"
                   type="number"><span>({{wallMegs.unit}})</span>
          </div>
          <div class="input-num-right" v-if="!dwType">
            <input class="input-num" v-model.number="widthVal" type="number" @input="oninput2" placeholder="宽">╳
            <input class="input-num" v-model.number="heightVal" type="number" @input="oninput3" placeholder="高">
...
<script>
  ...
  import {Switch, Stepper, Sku, Popup, Toast, Dialog, RadioGroup, Radio, Cell, CellGroup, Actionsheet} from 'vant';
  ...
  export default {
    ...
    methods: {
      ...
      //获取活动
      getHd(value) {
        console.log(value, value.itemNo, value.itemVersion)
      ...
      oninput(e) {
        ...
        console.log('e', e.target.value, this.sum)
      },
      oninput2(e) {
        var that = this
        // 通过正则过滤小数点后两位
        ...
        console.log('e', e.target.value, this.widthVal)
      },
      oninput3(e) {
        var that = this
        // 通过正则过滤小数点后两位
        ...
        console.log('e', e.target.value, this.heightVal)
      }
    },
    created() {
