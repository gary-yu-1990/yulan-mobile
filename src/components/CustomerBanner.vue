...
export default {
  ...
  mounted() {
      ...
      if(this.$store.state.info.data.realName.length >=7){
        ...
        document.getElementsByClassName('customer-name')[1].style.fontSize="18px"
      }else{
        document.getElementsByClassName('customer-name')[0].style.fontSize="15px"
        document.getElementsByClassName('customer-name')[1].style.fontSize="25px"
      }
      if(this.$store.state.info.data.realName.length >=10){
        document.getElementsByClassName('customer-name')[0].style.fontSize="8px"
        document.getElementsByClassName('customer-name')[1].style.fontSize="16px"
      }
  },
  methods: {
    Sidebar() {
